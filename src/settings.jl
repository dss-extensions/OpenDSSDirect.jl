module Settings
    ...
    function PriceCurve()::String
        return Utils.get_string(Utils.@checked Lib.Settings_Get_PriceCurve())
    end
    ...
    function ZoneLock(Value::Bool)
        Utils.@checked Lib.Settings_Set_ZoneLock(Value ? 1 : 0)
    end
    ...
    function AllocationFactors(Value::Float64)
        Utils.@checked Lib.Settings_Set_AllocationFactors(Value)
    end
