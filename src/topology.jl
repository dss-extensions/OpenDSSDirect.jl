module Topology
    ...
    function ActiveBranch()::Int
        return Utils.@checked Lib.Topology_Get_ActiveBranch()
    end

    """Topological depth of the active branch"""
    function ActiveLevel()::Int
        return Utils.@checked Lib.Topology_Get_ActiveLevel()
    end
