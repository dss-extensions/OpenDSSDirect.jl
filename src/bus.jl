...
function First(dss::DSSContext)::Int
    return @checked Lib.Circuit_SetActiveBusi(dss.ctx, 0)
end
...
function Idx(dss::DSSContext)::Int
    return @checked Lib.Bus_Get_idx(dss.ctx)
end
...
function Longitude(dss::DSSContext)::Float64
    return @checked Lib.Bus_Get_Longitude(dss.ctx)
end
...
function Longitude(dss::DSSContext, Value::Float64)
    @checked Lib.Bus_Set_Longitude(dss.ctx, Value)
end
...
function Latitude(dss::DSSContext)::Float64
    return @checked Lib.Bus_Get_Latitude(dss.ctx)
end
...
function Latitude(dss::DSSContext, Value::Float64)
    @checked Lib.Bus_Set_Latitude(dss.ctx, Value)
end
