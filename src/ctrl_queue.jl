module CtrlQueue
    ...
    function NumActions()::Int
        return Utils.@checked Lib.CtrlQueue_Get_NumActions()
    end

    """Pops next action off the action list and makes it the active action. Returns zero if none."""
    function PopAction()::Int
        return Utils.@checked Lib.CtrlQueue_Get_PopAction()
    end
    ...
    function QueueSize()::Int
        return Utils.@checked Lib.CtrlQueue_Get_QueueSize()
    end

    """(write-only) Set the active action by index"""
    function Action(Param1::Int)
        Utils.@checked Lib.CtrlQueue_Set_Action(Param1)
    end
