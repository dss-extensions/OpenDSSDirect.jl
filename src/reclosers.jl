module Reclosers
    ...
    """Close recloser"""
    function Close()
        Utils.@checked Lib.Reclosers_Close()
    end

    """Open recloser"""
    function Open()
        Utils.@checked Lib.Reclosers_Open()
    end
