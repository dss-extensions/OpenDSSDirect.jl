...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.Reclosers_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active Recloser object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Reclosers_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a Recloser object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Reclosers_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of Recloser Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Reclosers_Set_idx, dss.ctx, Value)
end
Idx(Value::Int) = Idx(DSS_DEFAULT_CTX, Value)

"""Close recloser"""
function Close(dss::DSSContext)
    @checked dss_ccall(dss.capi.Reclosers_Close, dss.ctx)
end
Close() = Close(DSS_DEFAULT_CTX)

"""Open recloser"""
function Open(dss::DSSContext)
    @checked dss_ccall(dss.capi.Reclosers_Open, dss.ctx)
end
...
function GroundInst(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.Reclosers_Get_GroundInst, dss.ctx)
end
...
function GroundInst(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.Reclosers_Set_GroundInst, dss.ctx, Value)
end
...
function GroundTrip(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.Reclosers_Get_GroundTrip, dss.ctx)
end
...
function GroundTrip(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.Reclosers_Set_GroundTrip, dss.ctx, Value)
end
...
function MonitoredObj(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Reclosers_Get_MonitoredObj, dss.ctx))
end
...
function MonitoredObj(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Reclosers_Set_MonitoredObj, dss.ctx, Value)
end
...
function MonitoredTerm(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_MonitoredTerm, dss.ctx)
end
...
function MonitoredTerm(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Reclosers_Set_MonitoredTerm, dss.ctx, Value)
end
...
function NumFast(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_NumFast, dss.ctx)
end
...
function NumFast(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Reclosers_Set_NumFast, dss.ctx, Value)
end
...
function PhaseInst(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.Reclosers_Get_PhaseInst, dss.ctx)
end
...
function PhaseInst(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.Reclosers_Set_PhaseInst, dss.ctx, Value)
end
...
function PhaseTrip(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.Reclosers_Get_PhaseTrip, dss.ctx)
end
...
function PhaseTrip(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.Reclosers_Set_PhaseTrip, dss.ctx, Value)
end
...
function Shots(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_Shots, dss.ctx)
end
...
function Shots(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Reclosers_Set_Shots, dss.ctx, Value)
end
...
function SwitchedObj(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Reclosers_Get_SwitchedObj, dss.ctx))
end
...
function SwitchedObj(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Reclosers_Set_SwitchedObj, dss.ctx, Value)
end
...
function SwitchedTerm(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Reclosers_Get_SwitchedTerm, dss.ctx)
end
...
function SwitchedTerm(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Reclosers_Set_SwitchedTerm, dss.ctx, Value)
end
...
function State(dss::DSSContext)::Lib.ActionCodes
    return @checked dss_ccall(dss.capi.Reclosers_Get_State, dss.ctx)
end
...
function State(dss::DSSContext, Value::Union{Int,Lib.ActionCodes})
    return @checked dss_ccall(dss.capi.Reclosers_Set_State, dss.ctx, Value)
end
...
function NormalState(dss::DSSContext)::Lib.ActionCodes
    return @checked dss_ccall(dss.capi.Reclosers_Get_NormalState, dss.ctx)
end
...
function NormalState(dss::DSSContext, Value::Union{Int,Lib.ActionCodes})
    return @checked dss_ccall(dss.capi.Reclosers_Set_NormalState, dss.ctx, Value)
end
...
function Reset(dss::DSSContext)
    @checked dss_ccall(dss.capi.Reclosers_Reset, dss.ctx)
end
