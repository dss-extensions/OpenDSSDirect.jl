module Capacitors
    ...
    function AddStep()::Bool
        return Utils.@checked(Lib.Capacitors_AddStep()) != 0
    end

    """Close all phases of Capacitor"""
    function Close()
        Utils.@checked Lib.Capacitors_Close()
    end

    """Open all phases of Capacitor"""
    function Open()
        Utils.@checked Lib.Capacitors_Open()
    end

    """Check if Capacitor SubtractStep is set"""
    function SubtractStep()::Bool
        return Utils.@checked(Lib.Capacitors_SubtractStep()) != 0
    end
