...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.LineGeometries_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active LineGeometry object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.LineGeometries_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a LineGeometry object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.LineGeometries_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of LineGeometry Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.LineGeometries_Set_idx, dss.ctx, Value)
end
...
function Ycoords(dss::DSSContext)::Array{Float64}
    return get_float64_array(dss.capi.LineGeometries_Get_Ycoords, dss)
end
...
function Ycoords(dss::DSSContext, Value::Array{Float64})
    set_float64_array(dss.capi.LineGeometries_Set_Ycoords, dss, Value)
end
...
function Xcoords(dss::DSSContext)::Array{Float64}
    return get_float64_array(dss.capi.LineGeometries_Get_Xcoords, dss)
end
...
function Xcoords(dss::DSSContext, Value::Float64)
    set_float64_array(dss.capi.LineGeometries_Set_Xcoords, dss, Value)
end
...
function RhoEarth(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.LineGeometries_Get_RhoEarth, dss.ctx)
end
...
function RhoEarth(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.LineGeometries_Set_RhoEarth, dss.ctx, Value)
end
...
function EmergAmps(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.LineGeometries_Get_EmergAmps, dss.ctx)
end
...
function EmergAmps(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.LineGeometries_Set_EmergAmps, dss.ctx, Value)
end
...
function NormAmps(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.LineGeometries_Get_NormAmps, dss.ctx)
end
...
function NormAmps(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.LineGeometries_Set_NormAmps, dss.ctx, Value)
end
...
function Units(dss::DSSContext, Value::Array{Int})
    set_int32_array(dss.capi.LineGeometries_Set_Units, dss, Value)
end
...
function Phases(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_Phases, dss.ctx)
end
...
function Phases(dss::DSSContext, Value::Int)
    return @checked dss_ccall(dss.capi.LineGeometries_Set_Phases, dss.ctx, Value)
end
...
function Nconds(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.LineGeometries_Get_Nconds, dss.ctx)
end
...
function Nconds(dss::DSSContext, Value::Int)
    return @checked dss_ccall(dss.capi.LineGeometries_Set_Nconds, dss.ctx, Value)
end
...
function Reduce(dss::DSSContext)::Bool
    return @checked dss_ccall(dss.capi.LineGeometries_Get_Reduce, dss.ctx)
end
...
function Reduce(dss::DSSContext, Value::Bool)
    return (@checked dss_ccall(dss.capi.LineGeometries_Set_Reduce, dss.ctx, Value)) != 0
end
...
function Conductors(dss::DSSContext)::Array{String}
    return get_string_array(dss.capi.LineGeometries_Get_Conductors, dss)
end
...
function Xmatrix(dss::DSSContext, Frequency::Float64, Length::Float64, Units::Union{Int32,Lib.LineUnits})::Array{Float64}
    return get_float64_array(dss.capi.LineGeometries_Get_Xmatrix, dss, Frequency, Length, Int32(Units))
    #TODO
end
...
function Rmatrix(dss::DSSContext, Frequency::Float64, Length::Float64, Units::Union{Int32,Lib.LineUnits})::Array{Float64}
    return get_float64_array(dss.capi.LineGeometries_Get_Rmatrix, dss, Frequency, Length, Int32(Units))
    #TODO
end
...
function Cmatrix(dss::DSSContext, Frequency::Float64, Length::Float64, Units::Union{Int32,Lib.LineUnits})::Array{Float64}
    return get_float64_array(dss.capi.LineGeometries_Get_Cmatrix, dss, Frequency, Length, Int32(Units))
end
...
function Zmatrix(dss::DSSContext, Frequency::Float64, Length::Float64, Units::Union{Int32,Lib.LineUnits})::Array{ComplexF64}
    return get_complex64_array(dss.capi.LineGeometries_Get_Zmatrix, dss, Frequency, Length, Int32(Units))
end
