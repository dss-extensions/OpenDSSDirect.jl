...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.Relays_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active Relay object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Relays_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a Relay object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Relays_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of Relay Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Relays_Set_idx, dss.ctx, Value)
end
...
function MonitoredObj(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Relays_Get_MonitoredObj, dss.ctx))
end
...
function MonitoredObj(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Relays_Set_MonitoredObj, dss.ctx, Value)
end
...
function MonitoredTerm(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_MonitoredTerm, dss.ctx)
end
...
function MonitoredTerm(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Relays_Set_MonitoredTerm, dss.ctx, Value)
end
...
function SwitchedObj(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Relays_Get_SwitchedObj, dss.ctx))
end
...
function SwitchedObj(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Relays_Set_SwitchedObj, dss.ctx, Value)
end
...
function SwitchedTerm(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Relays_Get_SwitchedTerm, dss.ctx)
end
...
function SwitchedTerm(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Relays_Set_SwitchedTerm, dss.ctx, Value)
end
...
function State(dss::DSSContext)::Lib.ActionCodes
    return @checked dss_ccall(dss.capi.Relays_Get_State, dss.ctx)
end
...
function State(dss::DSSContext, Value::Union{Int,Lib.ActionCodes})
    return @checked dss_ccall(dss.capi.Relays_Set_State, dss.ctx, Value)
end
...
function NormalState(dss::DSSContext)::Lib.ActionCodes
    return @checked dss_ccall(dss.capi.Relays_Get_NormalState, dss.ctx)
end
...
function NormalState(dss::DSSContext, Value::Union{Int,Lib.ActionCodes})
    return @checked dss_ccall(dss.capi.Relays_Set_NormalState, dss.ctx, Value)
end
...
function Reset(dss::DSSContext)
    @checked dss_ccall(dss.capi.Relays_Reset, dss.ctx)
end
