...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.Monitors_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active Monitor object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Monitors_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a Monitor object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Monitors_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of Monitor Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Monitors_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Monitors_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Monitors_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Monitors_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Monitors_Set_idx, dss.ctx, Value)
end
...
function Element(dss::DSSContext)::String
    result = get_string(dss_ccall(dss.capi.Monitors_Get_Element, dss.ctx))
    return result
end
...
function Element(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Monitors_Set_Element, dss.ctx, Value)
end
...
function Mode(dss::DSSContext)::Union{UInt32,Lib.MonitorModes}
    result = @checked dss_ccall(dss.capi.Monitors_Get_Mode, dss.ctx)
    try
...
function Mode(dss::DSSContext, Value::Union{Int,UInt32,Lib.MonitorModes})
    ...
    @checked dss_ccall(dss.capi.Monitors_Set_Mode, dss.ctx, Value)
end
...
function Terminal(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Monitors_Get_Terminal, dss.ctx)
end
...
function Terminal(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Monitors_Set_Terminal, dss.ctx, Value)
end
