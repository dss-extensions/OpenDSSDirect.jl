...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.GICSources_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active GICSource object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.GICSources_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a GICSource object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.GICSources_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of GICSource Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.GICSources_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.GICSources_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.GICSources_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.GICSources_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.GICSources_Set_idx, dss.ctx, Value)
end
...
function Lat2(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_Lat2, dss.ctx)
end
...
function Lat2(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_Lat2, dss.ctx, Value)
end
...
function Lat1(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_Lat1, dss.ctx)
end
...
function Lat1(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_Lat1, dss.ctx, Value)
end
...
function Lon1(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_Lon1, dss.ctx)
end
...
function Lon1(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_Lon1, dss.ctx, Value)
end
...
function Lon2(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_Lon2, dss.ctx)
end
...
function Lon2(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_Lon2, dss.ctx, Value)
end
...
function Phases(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.GICSources_Get_Phases, dss.ctx)
end
...
function Phases(dss::DSSContext, Value::Int)
    return @checked dss_ccall(dss.capi.GICSources_Set_Phases, dss.ctx, Value)
end
...
function EN(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_EN, dss.ctx)
end
...
function EN(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_EN, dss.ctx, Value)
end
...
function EE(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_EE, dss.ctx)
end
...
function EE(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_EE, dss.ctx, Value)
end
...
function Volts(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.GICSources_Get_Volts, dss.ctx)
end
...
function Volts(dss::DSSContext, Value::Float64)
    return @checked dss_ccall(dss.capi.GICSources_Set_Volts, dss.ctx, Value)
end
...
function Bus2(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.GICSources_Get_Bus2, dss.ctx))
end
...
function Bus1(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.GICSources_Get_Bus1, dss.ctx))
end
