module Fuses
    ...
    """Reset fuse"""
    function Close()
        Utils.@checked Lib.Fuses_Close()
    end

    """Check if the fuse is blown for any phase"""
    function IsBlown()::Bool
        return Utils.@checked(Lib.Fuses_IsBlown()) != 0
    end

    """Open all phases"""
    function Open()
        Utils.@checked Lib.Fuses_Open()
    end
    ...
    function Count()::Int
        return Utils.@checked Lib.Fuses_Get_Count()
    end
    ...
    function Delay()::Float64
        return Utils.@checked Lib.Fuses_Get_Delay()
    end
    ...
    function RatedCurrent()::Float64
        return Utils.@checked Lib.Fuses_Get_RatedCurrent()
    end
    ...
    function RatedCurrent(Value::Float64)
        Utils.@checked Lib.Fuses_Set_RatedCurrent(Value)
    end
    ...
    function SwitchedObj()::String
        return Utils.get_string(Utils.@checked Lib.Fuses_Get_SwitchedObj())
    end
    ...
    function SwitchedObj(Value::String)
        Utils.@checked Lib.Fuses_Set_SwitchedObj(Cstring(pointer(Value)))
    end
    ...
    function SwitchedTerm()::Int
        return Utils.@checked Lib.Fuses_Get_SwitchedTerm()
    end
    ...
    """
    function Idx()::Int
        return Utils.@checked Lib.Fuses_Get_idx()
    end
    ...
    function Idx(Value::Int)
        Utils.@checked Lib.Fuses_Set_idx(Value)
    end
