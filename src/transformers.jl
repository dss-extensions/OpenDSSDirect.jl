...
module Transformers
    ...
    function NumWindings(Value::Int)
        Utils.@checked Lib.Transformers_Set_NumWindings(Value)
    end

    """Active Winding resistance in % (Getter)"""
    function R()::Float64
        return Utils.@checked Lib.Transformers_Get_R()
    end

    """Active Winding resistance in % (Setter)"""
    function R(Value::Float64)
        Utils.@checked Lib.Transformers_Set_R(Value)
    end
    ...
    function Rneut()::Float64
        return Utils.@checked Lib.Transformers_Get_Rneut()
    end
    ...
    function Rneut(Value::Float64)
        Utils.@checked Lib.Transformers_Set_Rneut(Value)
    end

    """Active Winding tap in per-unit. (Getter)"""
    function Tap()::Float64
        return Utils.@checked Lib.Transformers_Get_Tap()
    end

    """Active Winding tap in per-unit. (Setter)"""
    function Tap(Value::Float64)
        Utils.@checked Lib.Transformers_Set_Tap(Value)
    end
    ...
    function Wdg()::Float64
        return Utils.@checked Lib.Transformers_Get_Wdg()
    end
    ...
    function Xhl()::Float64
        return Utils.@checked Lib.Transformers_Get_Xhl()
    end
    ...
    function Xhl(Value::Float64)
        Utils.@checked Lib.Transformers_Set_Xhl(Value)
    end
    ...
    function Xht()::Float64
        return Utils.@checked Lib.Transformers_Get_Xht()
    end
    ...
    function Xht(Value::Float64)
        Utils.@checked Lib.Transformers_Set_Xht(Value)
    end
    ...
    function Xlt()::Float64
        return Utils.@checked Lib.Transformers_Get_Xlt()
    end
    ...
    function kV(Value::Float64)
        Utils.@checked Lib.Transformers_Set_kV(Value)
    end
    ...
    function kVA()::Float64
        return Utils.@checked Lib.Transformers_Get_kVA()
    end
    ...
    function kVA(Value::Float64)
        Utils.@checked Lib.Transformers_Set_kVA(Value)
    end
