...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.XYCurves_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active XYCurve object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.XYCurves_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a XYCurve object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.XYCurves_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of XYCurve Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.XYCurves_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.XYCurves_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.XYCurves_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.XYCurves_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.XYCurves_Set_idx, dss.ctx, Value)
end
...
function Npts(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.XYCurves_Get_Npts, dss.ctx)
end
...
function Npts(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.XYCurves_Set_Npts, dss.ctx, Value)
end
...
function XArray(dss::DSSContext)::Vector{Float64}
    return get_float64_array(dss.capi.XYCurves_Get_Xarray, dss)
end
...
function XArray(dss::DSSContext, Value::Vector{Float64})
    ...
    @checked dss_ccall(dss.capi.XYCurves_Set_Xarray, dss.ctx, ValuePtr, ValueCount)
end
...
function XScale(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_Xscale, dss.ctx)
end
...
function XScale(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_Xscale, dss.ctx, Value)
end
...
function XShift(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_Xshift, dss.ctx)
end
...
function XShift(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_Xshift, dss.ctx, Value)
end
...
function YArray(dss::DSSContext)::Vector{Float64}
    return get_float64_array(dss.capi.XYCurves_Get_Yarray, dss)
end
...
function YArray(dss::DSSContext, Value::Vector{Float64})
    Value, ValuePtr, ValueCount = prepare_float64_array(Value)
    @checked dss_ccall(dss.capi.XYCurves_Set_Yarray, dss.ctx, ValuePtr, ValueCount)
end
...
function YScale(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_Yscale, dss.ctx)
end
...
function YScale(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_Yscale, dss.ctx, Value)
end
...
function YShift(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_Yshift, dss.ctx)
end
...
function YShift(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_Yshift, dss.ctx, Value)
end
...
function X(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_x, dss.ctx)
end
X() = X(DSS_DEFAULT_CTX)
...
function X(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_x, dss.ctx, Value)
end
...
function Y(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.XYCurves_Get_y, dss.ctx)
end
Y() = Y(DSS_DEFAULT_CTX)
...
function Y(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.XYCurves_Set_y, dss.ctx, Value)
end
