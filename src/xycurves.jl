...
module XYCurves
    ...
    function Count()::Int
        return Utils.@checked Lib.XYCurves_Get_Count()
    end

    """Sets first XYcurve object active; returns 0 if none."""
    function First()::Int
        return Utils.@checked Lib.XYCurves_Get_First()
    end

    """Name of active XYCurve Object (Getter)"""
    function Name()::String
        return Utils.get_string(Utils.@checked Lib.XYCurves_Get_Name())
    end

    """Name of active XYCurve Object (Setter)"""
    function Name(Value::String)
        Utils.@checked Lib.XYCurves_Set_Name(Value)
    end

    """Advances to next XYCurve object; returns 0 if no more objects of this class"""
    function Next()::Int
        return Utils.@checked Lib.XYCurves_Get_Next()
    end

    """Number of points in X-Y curve (Getter)"""
    function Npts()::Int
        return Utils.@checked Lib.XYCurves_Get_Npts()
    end

    """Number of points in X-Y curve (Setter)"""
    function Npts(Value::Int)
        Utils.@checked Lib.XYCurves_Set_Npts(Value)
    end
