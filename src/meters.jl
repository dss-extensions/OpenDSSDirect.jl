...
function AllNames(dss::DSSContext)::Vector{String}
    return get_string_array(dss.capi.Meters_Get_AllNames, dss)
end
AllNames() = AllNames(DSS_DEFAULT_CTX)

"""Gets the name of the active Meter object."""
function Name(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.Meters_Get_Name, dss.ctx))
end
Name() = Name(DSS_DEFAULT_CTX)

"""Sets a Meter object active by name."""
function Name(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Meters_Set_Name, dss.ctx, Value)
end
Name(Value::String) = Name(DSS_DEFAULT_CTX, Value)

"""Number of Meter Objects in Active Circuit"""
function Count(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_Count, dss.ctx)
end
...
function First(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_First, dss.ctx)
end
...
function Next(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_Next, dss.ctx)
end
...
function Idx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_idx, dss.ctx)
end
...
function Idx(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Meters_Set_idx, dss.ctx, Value)
end
...
function SetActiveSection(dss::DSSContext, SectIdx::Int)
    @checked dss_ccall(dss.capi.Meters_SetActiveSection, dss.ctx, SectIdx)
end
...
function AllocFactors(dss::DSSContext)::Vector{Float64}
    return get_float64_array(dss.capi.Meters_Get_AllocFactors, dss)
end
...
function AllocFactors(dss::DSSContext, Value::Vector{Float64})
    ...
    @checked dss_ccall(dss.capi.Meters_Set_AllocFactors, dss.ctx, ValuePtr, ValueCount)
end
...
function CalcCurrent(dss::DSSContext)::Vector{Float64}
    return get_float64_array(dss.capi.Meters_Get_CalcCurrent, dss)
end
...
function CalcCurrent(dss::DSSContext, Value::Vector{Float64})
    Value, ValuePtr, ValueCount = prepare_float64_array(Value)
    @checked dss_ccall(dss.capi.Meters_Set_CalcCurrent, dss.ctx, ValuePtr, ValueCount)
end
...
function MeteredElement(dss::DSSContext)::String
    return get_string(dss_ccall(dss.capi.Meters_Get_MeteredElement, dss.ctx))
end
...
function MeteredElement(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.Meters_Set_MeteredElement, dss.ctx, Value)
end
...
function MeteredTerminal(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_MeteredTerminal, dss.ctx)
end
...
function MeteredTerminal(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Meters_Set_MeteredTerminal, dss.ctx, Value)
end
...
function OCPDeviceType(dss::DSSContext)::Int
    # TODO: use enum here?
    return @checked dss_ccall(dss.capi.Meters_Get_OCPDeviceType, dss.ctx)
end
...
function PeakCurrent(dss::DSSContext)::Vector{Float64}
    return get_float64_array(dss.capi.Meters_Get_Peakcurrent, dss)
end
...
function PeakCurrent(dss::DSSContext, Value::Vector{Float64})
    Value, ValuePtr, ValueCount = prepare_float64_array(Value)
    @checked dss_ccall(dss.capi.Meters_Set_Peakcurrent, dss.ctx, ValuePtr, ValueCount)
end
...
function SAIFIkW(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.Meters_Get_SAIFIKW, dss.ctx)
end
...
function SectSeqidx(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_SectSeqIdx, dss.ctx)
end
...
function SequenceIndex(dss::DSSContext)::Int
    return @checked dss_ccall(dss.capi.Meters_Get_SequenceIndex, dss.ctx)
end
...
function SequenceIndex(dss::DSSContext, Value::Int)
    @checked dss_ccall(dss.capi.Meters_Set_SequenceIndex, dss.ctx, Value)
end
