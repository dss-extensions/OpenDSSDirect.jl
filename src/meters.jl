module Meters
    ...
    function CloseAllDIFiles()
        Utils.@checked Lib.Meters_CloseAllDIFiles()
    end

    """Do reliability calculation"""
    function DoReliabilityCalc(AssumeRestoration::Bool)
        Utils.@checked Lib.Meters_DoReliabilityCalc(AssumeRestoration ? 1 : 0)
    end

    """Open all DI Files"""
    function OpenAllDIFiles()
        Utils.@checked Lib.Meters_OpenAllDIFiles()
    end

    """Reset meter"""
    function Reset()
        Utils.@checked Lib.Meters_Reset()
    end

    """Reset all meters"""
    function ResetAll()
        Utils.@checked Lib.Meters_ResetAll()
    end

    """Sample meter"""
    function Sample()
        Utils.@checked Lib.Meters_Sample()
    end

    """Sample all meters"""
    function SampleAll()
        Utils.@checked Lib.Meters_SampleAll()
    end

    """Save meter registers"""
    function Save()
        Utils.@checked Lib.Meters_Save()
    end

    """Save all meters registers"""
    function SaveAll()
        Utils.@checked Lib.Meters_SaveAll()
    end

    """Set active section"""
    function SetActiveSection(SectIdx::Int)
        Utils.@checked Lib.Meters_SetActiveSection(SectIdx)
    end
    ...
    function AllocFactors(Value::Vector{Float64})
        ...
        Utils.@checked Lib.Meters_Set_AllocFactors(ValuePtr, ValueCount)
    end

    """Average Repair time in this section of the meter zone"""
    function AvgRepairTime()::Float64
        return Utils.@checked Lib.Meters_Get_AvgRepairTime()
    end
    ...
    function CalcCurrent(Value::Vector{Float64})
        Value, ValuePtr, ValueCount = Utils.prepare_float64_array(Value)
        Utils.@checked Lib.Meters_Set_CalcCurrent(ValuePtr, ValueCount)
    end

    """Number of Energy Meters in the Active Circuit"""
    function Count()::Int
        return Utils.@checked Lib.Meters_Get_Count()
    end

    """Number of branches in Active energymeter zone. (Same as sequencelist size)"""
    function CountBranches()::Int
        return Utils.@checked Lib.Meters_Get_CountBranches()
    end

    """Number of zone end elements in the active meter zone."""
    function CountEndElements()::Int
        return Utils.@checked Lib.Meters_Get_CountEndElements()
    end
    ...
    function MeteredElement(Value::String)
        Utils.@checked Lib.Meters_Set_MeteredElement(Cstring(pointer(Value)))
    end

    """set Number of Metered Terminal"""
    function MeteredTerminal()::Int
        return Utils.@checked Lib.Meters_Get_MeteredTerminal()
    end

    """set Number of Metered Terminal"""
    function MeteredTerminal(Value::Int)
        Utils.@checked Lib.Meters_Set_MeteredTerminal(Value)
    end
    ...
    function Name()::String
        return Utils.get_string(Utils.@checked Lib.Meters_Get_Name())
    end
    ...
    function PeakCurrent(Value::Vector{Float64})
        Value, ValuePtr, ValueCount = Utils.prepare_float64_array(Value)
        Utils.@checked Lib.Meters_Set_Peakcurrent(ValuePtr, ValueCount)
    end
