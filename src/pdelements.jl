...
module PDElements
    ...
    function AccumulatedL()::Float64
        return Utils.@checked Lib.PDElements_Get_AccumulatedL()
    end

    """Number of PD elements (including disabled elements)"""
    function Count()::Int
        return Utils.@checked Lib.PDElements_Get_Count()
    end
    ...
    function FaultRate()::Float64
        return Utils.@checked Lib.PDElements_Get_FaultRate()
    end
    ...
    function FaultRate(Value::Float64)
        Utils.@checked Lib.PDElements_Set_FaultRate(Value)
    end

    """Set the first enabled PD element to be the active element.  Returns 0 if none found."""
    function First()::Int
        return Utils.@checked Lib.PDElements_Get_First()
    end
    ...
    function FromTerminal()::Int
        return Utils.@checked Lib.PDElements_Get_FromTerminal()
    end
    ...
    function PctPermanent()::Float64
        return Utils.@checked Lib.PDElements_Get_pctPermanent()
    end
    ...
    function PctPermanent(Value::Float64)
        Utils.@checked Lib.PDElements_Set_pctPermanent(Value)
    end
