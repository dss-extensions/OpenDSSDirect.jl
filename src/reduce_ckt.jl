...
function EnergyMeter(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.ReduceCkt_Get_EnergyMeter, dss.ctx))
end
...
function EnergyMeter(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.ReduceCkt_Set_EnergyMeter, dss.ctx, Value)
end
...
function KeepLoad(dss::DSSContext)::Bool
    return (@checked dss_ccall(dss.capi.ReduceCkt_Get_KeepLoad, dss.ctx)) != 0
end
...
function KeepLoad(dss::DSSContext, Value::Bool)
    @checked dss_ccall(dss.capi.ReduceCkt_Set_KeepLoad, dss.ctx, Value)
end
...
function EditString(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.ReduceCkt_Get_EditString, dss.ctx))
end
...
function EditString(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.ReduceCkt_Set_EditString, dss.ctx, Value)
end
...
function Zmag(dss::DSSContext)::Float64
    return @checked dss_ccall(dss.capi.ReduceCkt_Get_Zmag, dss.ctx)
end
...
function Zmag(dss::DSSContext, Value::Float64)
    @checked dss_ccall(dss.capi.ReduceCkt_Set_Zmag, dss.ctx, Value)
end
...
function StartPDElement(dss::DSSContext)::String
    return get_string(@checked dss_ccall(dss.capi.ReduceCkt_Get_StartPDElement, dss.ctx))
end
...
function StartPDElement(dss::DSSContext, Value::String)
    @checked dss_ccall(dss.capi.ReduceCkt_Set_StartPDElement, dss.ctx, Value)
end
...
function Do1phLaterals(dss::DSSContext)
    @checked dss_ccall(dss.capi.ReduceCkt_Do1phLaterals, dss.ctx)
end
...
function DoParallelLines(dss::DSSContext)
    @checked dss_ccall(dss.capi.ReduceCkt_DoParallelLines, dss.ctx)
end
...
function SaveCircuit(dss::DSSContext, CktName::String)
    @checked dss_ccall(dss.capi.ReduceCkt_SaveCircuit, dss.ctx, CktName)
end
...
function DoBranchRemove(dss::DSSContext)
    @checked dss_ccall(dss.capi.ReduceCkt_DoBranchRemove, dss.ctx)
end
...
function DoLoopBreak(dss::DSSContext)
    @checked dss_ccall(dss.capi.ReduceCkt_DoLoopBreak, dss.ctx)
end
...
function DoSwitches(dss::DSSContext)
    @checked dss_ccall(dss.capi.ReduceCkt_DoSwitches, dss.ctx)
end
