...
"""
Sets first Reactor to be active.
Returns 0 if none.
"""
...
"""
Sets next Reactor to be active.
...
"""
Returns the index of the current active Reactor (1-based)
...
"""
Activate Reactor by index (1-based)
...
"""
Zero-sequence impedance, ohms, as a complex number.
...
"""
Positive-sequence impedance, ohms, as a complex number.
...
"""
Negative-sequence impedance, ohms, as as a complex number.
