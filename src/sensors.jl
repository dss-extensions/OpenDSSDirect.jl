module Sensors
    ...
    function Reset()
        Utils.@checked Lib.Sensors_Reset()
    end

    function ResetAll()
        Utils.@checked Lib.Sensors_ResetAll()
    end
    ...
    function Count()::Int
        return Utils.@checked Lib.Sensors_Get_Count()
    end
    ...
    function Weight(Value::Float64)
        Utils.@checked Lib.Sensors_Set_Weight(Value)
    end
    ...
    function kvar(Value::Vector{Float64})
        Value, ValuePtr, ValueCount = Utils.prepare_float64_array(Value)
        Utils.@checked Lib.Sensors_Set_kVARS(ValuePtr, ValueCount)
    end
    ...
    function kVS(Value::Vector{Float64})
        Value, ValuePtr, ValueCount = Utils.prepare_float64_array(Value)
        Utils.@checked Lib.Sensors_Set_kVS(ValuePtr, ValueCount)
    end
    ...
    function kVBase()::Float64
        return Utils.@checked Lib.Sensors_Get_kVbase()
    end
    ...
    function kVBase(Value::Float64)
        Utils.@checked Lib.Sensors_Set_kVbase(Value)
    end
    ...
    function kW(Value::Vector{Float64})
        Value, ValuePtr, ValueCount = Utils.prepare_float64_array(Value)
        Utils.@checked Lib.Sensors_Set_kWS(ValuePtr, ValueCount)
    end
