module Solution
    ...
    function BuildYMatrix(BuildOption::Int, AllocateVI::Int)
        Utils.@checked Lib.Solution_BuildYMatrix(BuildOption, AllocateVI)
    end

    """Check Controls"""
    function CheckControls()
        Utils.@checked Lib.Solution_CheckControls()
    end

    """Check Fault Status"""
    function CheckFaultStatus()
        Utils.@checked Lib.Solution_CheckFaultStatus()
    end

    """Clean up Solution"""
    function Cleanup()
        Utils.@checked Lib.Solution_Cleanup()
    end

    """Do Control Actions"""
    function DoControlActions()
        Utils.@checked Lib.Solution_DoControlActions()
    end

    """Finish Time Step"""
    function FinishTimeStep()
        Utils.@checked Lib.Solution_FinishTimeStep()
    end

    """Initialize Snapshot Solution"""
    function InitSnap()
        Utils.@checked Lib.Solution_InitSnap()
    end

    """Sample Control Devices"""
    function SampleControlDevices()
        Utils.@checked Lib.Solution_SampleControlDevices()
    end

    """Sample Do Control Actions"""
    function SampleDoControlActions()
        Utils.@checked Lib.Solution_Sample_DoControlActions()
    end

    """Solve"""
    function Solve()
        Utils.@checked Lib.Solution_Solve()
    end

    """Solve direct"""
    function SolveDirect()
        Utils.@checked Lib.Solution_SolveDirect()
    end

    """Solve no control"""
    function SolveNoControl()
        Utils.@checked Lib.Solution_SolveNoControl()
    end

    """Solve Power Flow"""
    function SolvePFlow()
        Utils.@checked Lib.Solution_SolvePflow()
    end

    """Solve Plus Control"""
    function SolvePlusControl()
        Utils.@checked Lib.Solution_SolvePlusControl()
    end

    """Solve Snap"""
    function SolveSnap()
        Utils.@checked Lib.Solution_SolveSnap()
    end

    """Type of device to add in AutoAdd Mode: {dssGen (Default) | dssCap} (Getter)"""
    function AddType()::Lib.AutoAddTypes
        return Utils.@checked Lib.Solution_Get_AddType()
    end
    ...
    function IntervalHrs()::Float64
        return Utils.@checked Lib.Solution_Get_IntervalHrs()
    end
    ...
    function IntervalHrs(Value::Float64)
        Utils.@checked Lib.Solution_Set_IntervalHrs(Value)
    end

    """Number of iterations taken for last solution. (Same as TotalIterations)"""
    function Iterations()::Int
        return Utils.@checked Lib.Solution_Get_Iterations()
    end

    """Load-Duration Curve name for LD modes"""
    function LDCurve()::String
        return Utils.get_string(Utils.@checked Lib.Solution_Get_LDCurve())
    end

    """Load-Duration Curve name for LD modes"""
    function LDCurve(Value::String)
        Utils.@checked Lib.Solution_Set_LDCurve(Value)
    end

    """Load Model: {dssPowerFlow (default) | dssAdmittance}"""
    function LoadModel()::Lib.SolutionLoadModels
        return Utils.@checked Lib.Solution_Get_LoadModel()
    end

    """Load Model: {dssPowerFlow (default) | dssAdmittance}"""
    function LoadModel(Value::Union{Int, Lib.SolutionLoadModels})
        Value = convert(Lib.SolutionLoadModels, Value)
        Utils.@checked Lib.Solution_Set_LoadModel(Value)
    end

    """Default load multiplier applied to all non-fixed loads"""
    function LoadMult()::Float64
        return Utils.@checked Lib.Solution_Get_LoadMult()
    end

    """Default load multiplier applied to all non-fixed loads"""
    function LoadMult(Value::Float64)
        Utils.@checked Lib.Solution_Set_LoadMult(Value)
    end

    """Maximum allowable control iterations"""
    function MaxControlIterations()::Int
        return Utils.@checked Lib.Solution_Get_MaxControlIterations()
    end

    """Maximum allowable control iterations"""
    function MaxControlIterations(Value::Int)
        Utils.@checked Lib.Solution_Set_MaxControlIterations(Value)
    end

    """Max allowable iterations."""
    function MaxIterations()::Int
        return Utils.@checked Lib.Solution_Get_MaxIterations()
    end

    """Max allowable iterations."""
    function MaxIterations(Value::Int)
        Utils.@checked Lib.Solution_Set_MaxIterations(Value)
    end
    ...
    function MinIterations()::Int
        return Utils.@checked Lib.Solution_Get_MinIterations()
    end
    ...
    function MinIterations(Value::Int)
        Utils.@checked Lib.Solution_Set_MinIterations(Value)
    end

    """Get present solution mode (by a text code - see DSS Help)"""
    function Mode()::Lib.SolveModes
        return Utils.@checked Lib.Solution_Get_Mode()
    end
    ...
    function Mode(Value::Union{Int, Lib.SolveModes})
        ...
        Utils.@checked Lib.Solution_Set_Mode(Value)
    end

    """ID (text) of the present solution mode"""
    function ModeID()::String
        return Utils.get_string(Utils.@checked Lib.Solution_Get_ModeID())
    end
    ...
    function MostIterationsDone()::Int
        return Utils.@checked Lib.Solution_Get_MostIterationsDone()
    end

    """Number of solutions to perform for Monte Carlo and time series simulations"""
    function Number()::Int
        return Utils.@checked Lib.Solution_Get_Number()
    end

    """Number of solutions to perform for Monte Carlo and time series simulations"""
    function Number(Value::Int)
        Utils.@checked Lib.Solution_Set_Number(Value)
    end

    """Gets the time required to perform the latest solution (Read only)"""
    function ProcessTime()::Float64
        return Utils.@checked Lib.Solution_Get_Process_Time()
    end

    """Randomization mode for random variables "Gaussian" or "Uniform" (Getter)"""
    function Random()::Lib.RandomModes
        return Utils.@checked Lib.Solution_Get_Random()
    end
    ...
    function Random(Value::Union{Int, Lib.RandomModes})
        ...
        Utils.@checked Lib.Solution_Set_Random(Value)
    end

    """Seconds from top of the hour."""
    function Seconds()::Float64
        return Utils.@checked Lib.Solution_Get_Seconds()
    end

    """Seconds from top of the hour."""
    function Seconds(Value::Float64)
        Utils.@checked Lib.Solution_Set_Seconds(Value)
    end

    """Time step size in sec"""
    function StepSize()::Float64
        return Utils.@checked Lib.Solution_Get_StepSize()
    end

    """Time step size in sec"""
    function StepSize(Value::Float64)
        Utils.@checked Lib.Solution_Set_StepSize(Value)
    end

    """Flag that indicates if elements of the System Y have been changed by recent activity."""
    function SystemYChanged()::Bool
        return Utils.@checked(Lib.Solution_Get_SystemYChanged()) != 0
    end

    """Get the solution process time + sample time for time step"""
    function TimeTimeStep()::Float64
        return Utils.@checked Lib.Solution_Get_Time_of_Step()
    end

    """Solution convergence tolerance."""
    function Convergence()::Float64
        return Utils.@checked Lib.Solution_Get_Tolerance()
    end

    """Solution convergence tolerance."""
    function Convergence(Value::Float64)
        Utils.@checked Lib.Solution_Set_Tolerance(Value)
    end
    ...
    function TotalTime()::Float64
        return Utils.@checked Lib.Solution_Get_Total_Time()
    end
