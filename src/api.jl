...
@def	0	parser	ParserS	6	BeginQuote	"Get the string containing the characters for quoting in OpenDSS scripts. Matching pairs defined in EndQuote."	
@def	1	parser	ParserS	7	BeginQuote	"Set the string containing the characters for quoting in OpenDSS scripts. Matching pairs defined in EndQuote."	
@def	0	parser	ParserS	8	EndQuote	"Get the string containing the characters, in order, that match the beginning quote characters in BeginQuote. "	
@def	1	parser	ParserS	9	EndQuote	"Set the string containing the characters, in order, that match the beginning quote characters in BeginQuote. "	
