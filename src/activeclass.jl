module ActiveClass
    ...
    function ActiveClassName()::String
        return Utils.get_string(Utils.@checked Lib.ActiveClass_Get_ActiveClassName())
    end
    ...
    function Count()::Int
        return Utils.@checked Lib.ActiveClass_Get_Count()
    end
    ...
    function First()::Int
        return Utils.@checked Lib.ActiveClass_Get_First()
    end
    ...
    function Name(Value::String)
        Utils.@checked Lib.ActiveClass_Set_Name(Cstring(pointer(Value)))
    end
    ...
    function Next()::Int
        return Utils.@checked Lib.ActiveClass_Get_Next()
    end


    """Number of elements in this class. Same as Count property."""
    function NumElements()::Int
        return Utils.@checked Lib.ActiveClass_Get_NumElements()
    end
