module RegControls
    ...
    function CTPrimary()::Float64
        return Utils.@checked Lib.RegControls_Get_CTPrimary()
    end

    """CT primary ampere rating (secondary is 0.2 amperes) (Setter)"""
    function CTPrimary(Value::Float64)
        Utils.@checked Lib.RegControls_Set_CTPrimary(Value)
    end

    """Number of RegControl objects in Active Circuit"""
    function Count()::Int
        return Utils.@checked Lib.RegControls_Get_Count()
    end
    ...
    function Delay()::Float64
        return Utils.@checked Lib.RegControls_Get_Delay()
    end
    ...
    function IsInverseTime()::Bool
        return Utils.@checked(Lib.RegControls_Get_IsInverseTime()) != 0
    end
    ...
    function IsInverseTime(Value::Bool)
        Utils.@checked Lib.RegControls_Set_IsInverseTime(Value ? 1 : 0)
    end
    ...
    function IsReversible()::Bool
        return Utils.@checked(Lib.RegControls_Get_IsReversible()) != 0
    end
    ...
    function IsReversible(Value::Bool)
        Utils.@checked Lib.RegControls_Set_IsReversible(Value ? 1 : 0)
    end
    ...
    function MaxTapChange()::Float64
        return Utils.@checked Lib.RegControls_Get_MaxTapChange()
    end
    ...
    function TapDelay()::Float64
        return Utils.@checked Lib.RegControls_Get_TapDelay()
    end
